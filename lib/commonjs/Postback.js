...
var _NativePostback = require("./NativePostback");
...
class PostbackSDK {
  async configure(configOrApiKey, options = {}) {
    ...
    return _NativePostback.NativePostback.configure(config);
  }
  async sendEvent(eventType, name, params) {
    ...
    return _NativePostback.NativePostback.sendEvent(nativeEventType, nativeName, revenueValue(params), normalizeCurrency(params?.currency), nativeParams);
  }
  async sendTestEvent() {
    return _NativePostback.NativePostback.sendTestEvent();
  }
  async flush() {
    await _NativePostback.NativePostback.flush();
  }
  async clearData() {
    await _NativePostback.NativePostback.clearData();
  }
  async setCustomerUserId(userId) {
    await _NativePostback.NativePostback.setCustomerUserId(userId);
  }
  async refreshAttribution() {
    return _NativePostback.NativePostback.refreshAttribution();
  }
  async enableAppleAdsAttribution() {
    return _NativePostback.NativePostback.enableAppleAdsAttribution();
  }
  async getPostbackId() {
    return _NativePostback.NativePostback.getPostbackId();
  }
  async getAttribution() {
    return _NativePostback.NativePostback.getAttribution();
  }
  async getAttributionParams() {
    return _NativePostback.NativePostback.getAttributionParams();
  }
  async isInitialized() {
    return _NativePostback.NativePostback.isInitialized();
  }
  async isSdkDisabled() {
    return _NativePostback.NativePostback.isSdkDisabled();
  }
  async destroy() {
    await _NativePostback.NativePostback.destroy();
  }
}
const Postback = exports.Postback = new PostbackSDK();
